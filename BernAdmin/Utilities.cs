...
{ 
    public partial class DGAdmin
    {
        ...
        public static partial class ConfigValues
        {
            ...
            public static bool settings_improved_reload
            {
                get
                {
                    return bool.Parse(Sett_GetString("settings_improved_reload"));
                }
            }

            public static bool settings_pistol_throw
            {
                get
                {
                    return bool.Parse(Sett_GetString("settings_pistol_throw"));
                }
            }

            public static bool settings_john_woo_powers
            {
                get
                {
                    return bool.Parse(Sett_GetString("settings_john_woo_powers"));
                }
            }
        ...
        public void UTILS_ImprovedReload(Entity player)
        {
        ...
        public void UTILS_KnivesToAGunFight()
        {
            OnInterval(50, () =>
            {
                foreach (Entity player in from player in Players where player.IsAlive select player)
        ...
        public void UTILS_ResetThrowingKnifeOnDeath(Entity player, Entity inflictor, Entity attacker, int damage, string mod, string weapon, Vector3 dir, string hitLoc)
        {
            player.ClearField("gunThrowMode");
            player.ClearField("grenadeBackup");
            player.ClearField("grenadeBackupClass");
        ...
        public void UTILS_WeaponThrow(Entity player)
        {
        ...
        public void UTILS_JumpDamageThink(Entity victim, Entity inflictor, Entity attacker, int damage, int dFlags, string mod, string weapon, Vector3 point, Vector3 dir, string hitLoc)
        {
