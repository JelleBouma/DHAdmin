...
namespace LambAdmin
{
    public partial class DHAdmin
    {
        ...
        public void InitCommands()
        {
            ...
            // SOUND
            CommandList.Add(new Command("sound", 1, Command.Behaviour.Normal,
                (sender, arguments, optarg) =>
                {
                    sender.PlaySound(arguments[0]);
                }));
            ...
            // PLAYFX
            CommandList.Add(new Command("playfx", 1, Command.Behaviour.HasOptionalArguments,
                (sender, arguments, optarg) =>
                {
                    GSCFunctions.PlayFX(GSCFunctions.LoadFX(arguments[0]), sender.Origin);
                }));
                        ...
                        AfterDelay(50, () =>
                        {
                            ...
                            AfterDelay(1000, () =>
                            {
                                if (((target.CurrentWeapon == "none") && takeWeapons) ||                        
                                    ((target.CurrentWeapon == orig_weapon) && !takeWeapons))            
                                {                                                                                                                               
                                    if (takeWeapons)                                                                
                                    {                                                                                                                             
